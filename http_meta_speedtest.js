 ...
 *   3.测速失败的节点。现在可以通过新参数[remove_failed]决定是否移除。
 *   4.现在可以通过新参数[minRequiredSpeed]筛选速度过低的节点，默认:20Mbps，如果节点速度低于设定值，写入格式会使用繁体[下載速度：${speed}]。通过substore正则筛选繁体“下載速度”可以移除速度低于20Mbps的节点。
 *   5.新增新参数url_sg 和url_us，用于测速新加坡和美东的节点
...
async function operator(proxies = [], targetPlatform, context) {
  ...
  const remove_failed = $arguments.remove_failed ?? true;
